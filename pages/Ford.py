...
model_path = "saved_models/F_model.joblib"  # Path to your trained model
model = joblib.load(model_path)  # Load model using joblib

scaler_path = "saved_models/F_scaler.joblib"  
scaler = joblib.load(scaler_path)


# Load selected features
features_path = f"saved_models/F_selected_f.joblib"
...
st.set_page_config(page_title="Ford Stock Prediction", layout="wide")

# Apple Logo & Title
st.image("https://images.seeklogo.com/logo-png/5/1/ford-logo-png_seeklogo-56584.png", width=150)
st.title("Ford Stock Prediction")
st.write("Analyze and predict Ford's stock price movements with AI-powered insights.")
