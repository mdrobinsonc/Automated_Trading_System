...
features_path = f"saved_models/NFLX_selected_f.joblib"
...
st.subheader("**As it is a logistic regression model, Please select larger range of dates, preferably 2 years or more**")
...
fig.update_layout(title="📊 Netflix Stock Candlestick Chart", template="plotly_dark")
